...
- aggiunte tabelle server-only `oauth_states`, `provider_events`, `google_watch_channels`;
...
- RLS attiva sulle tre nuove tabelle: `true`;
- policy anon referral rimasta: `0`;
- policy audit globale autenticati rimasta: `0`;
- indice univoco coda attiva: presente.
